...
def handlestart(message):
    ...
    bot.send_message(chatid, "👋 PSCLive डाउनलोडर बॉट\n\n1️⃣ कोर्स का URL या ID भेजें:")
...
def handleselection(message):
    ...
    # 1. पहले जांचें कि क्या इसके अंदर और सब-आइटम्स/फ़ोल्डर्स हैं
    ...
    # 2. अगर सब-फ़ोल्डर नहीं है, तो डाउनलोड लिंक निकालें
    ...
    try:
        ...
        # अगर फ़ाइल 49 MB से बड़ी है (टेलीग्राम 50 MB लिमिट)
        if size_mb > 49:
            bot.send_message(
                chatid,
                f"ℹ️ फ़ाइल का आकार {size_mb:.2f} MB है (Telegram की 50 MB सीमा से बड़ा)।\n\n🔗 डायरेक्ट डाउनलोड लिंक आपके चैनल पर भेज दिया गया है।"
            )
            bot.send_message(
                TARGETCHANNEL,
                f"📚 {file_title}\n📦 साइज़: {size_mb:.2f} MB\n\n🔗 डाउनलोड लिंक:\n{file_url}"
            )
            bot.send_message(chatid, f"✅ सफलता! फ़ाइल का लिंक चैनल {TARGETCHANNEL} पर भेज दिया गया है।")
            return
        ...
        bot.send_message(chatid, f"✅ सफलता! {file_title} चैनल पर अपलोड हो गई है।\n\n👉 अगली फ़ाइल का नंबर भेजें।")
